...
const VideoCall= () =>{
  ...
  useEffect(() => {
    setTimeout(() => {
      var doctorUserCode = "e349d69e-9705-4af3-92a1-8c3eb1eeab29"
      var patientUserCode = "c46edab6-7e41-44e0-bed0-ee3da74d6b16"
      var d = new Date();
      d = d.getYear() + d.getDay() + d.getMonth();
      var key = sha256(doctorUserCode + d + patientUserCode);
      console.log("key")
      console.log(key)

      const url = 'https://meet.jit.si/'+key;
      const options = {
        audioMuted: false,
        audioOnly: false,
        videoMuted: false,
